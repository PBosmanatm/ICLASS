...
constr_succes_state_ens = False#used in e.g. plot_1d_pdfs, can be turned off if unused to reduce number of calculations 
...
print_estim_post_param_stdev = False #print estimated standard deviation of posterior parameters
...
load_second_optim = True #load a second optimisation (not just a second ensemble member)
