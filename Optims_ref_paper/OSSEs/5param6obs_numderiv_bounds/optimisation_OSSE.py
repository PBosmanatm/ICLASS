...
#    boundedvars['gammaq'] = [-9e-6,9e-6]
    ...
    boundedvars['alpha'] = [0.01,0.99] 
    boundedvars['sca_sto'] = [0.01,50]
    boundedvars['wg'] = [priorinput.wwilt+0.0001,priorinput.wsat-0.0001]
    boundedvars['h'] = [5,4000]
    boundedvars['gammatheta'] = [0.00005,0.030]
